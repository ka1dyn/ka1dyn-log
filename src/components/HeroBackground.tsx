...
export default function HeroBackground() {
  ...
  return (
    <div
      ref={containerRef}
      className="absolute inset-0 overflow-hidden group z-20"
      aria-hidden="true"
    >
      {/* 1. 마우스 추적 Glow 효과 */}
      <div
        className="absolute transition-opacity opacity-0 duration-500 ease-in-out bg-primary/10 blur-[80px] rounded-full group-hover:opacity-100 "
        style={{
          width: "200px",
          height: "200px",
